...
public class QuizApplication extends JFrame implements ActionListener {
   ...
   JRadioButton radioButtons[]=new JRadioButton[5];  //options for every question
    ...
    QuizApplication(String s){
        ...
        add(label);       //add() method is typically used to add components to a container in Swing-based user interface development.
        ...
        btnResult.addActionListener(this);   //When the button is clicked, an action event will be triggered, and the listener will be notified.
        btnNext.addActionListener(this);      // The addActionListener() method is used to add an ActionListener to the button, and
                                    // the argument this indicates that the current object (the one containing this code) is the ActionListener.
   ...
   if(current==0){
       label.setText("Question 1: Which of the following is a popular front-end JavaScript framework?");    //inserting  text in a label and radio buttons.
       ...
       radioButtons[3].setText("d) Node.js");
        ...
        if(current==1){
            label.setText("Question 2: Which technology is used for creating decentralized applications (dApps)?");    //inserting  text in a label and radio buttons.
        ...
        if(current==2){
            label.setText("Question 3: Which programming language is commonly used for developing machine learning models?");    //inserting  text in a label and radio buttons.
        ...
        if(current==4){
            label.setText("Question 5: Which technology is used for real-time communication between web browsers and servers?");    //inserting  text in a label and radio buttons.
        ...
        if(current==5){
            label.setText("Question 6: Which of the following is an open-source relational database management system?");    //inserting  text in a label and radio buttons.
        ...
        if(current==6){
            label.setText("Question 7: Which technology is used for building native mobile applications for iOS and Android platforms?");    //inserting  text in a label and radio buttons.
        ...
        if(current==7){
            label.setText("Question 8: What is the purpose of Kubernetes?");    //inserting  text in a label and radio buttons.
        ...
        if(current==8){
            label.setText("Question 9: Which cloud computing provider offers services such as EC2, S3, and Lambda?");    //inserting  text in a label and radio buttons.
        ...
        if(current==9){
            label.setText("Question 10: Which programming language is commonly used for developing smart contracts on blockchain platforms?");    //inserting  text in a label and radio buttons.
    ...
    {
        new QuizApplication("A Quiz Application");
    }
